...
class ExpresionesParser ( Parser ):
    ...
    class ExprContext(ParserRuleContext):
        ...
        def PAI(self):
            return self.getToken(ExpresionesParser.PAI, 0)
        ...
        def PAD(self):
            return self.getToken(ExpresionesParser.PAD, 0)
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [5]:
                self.state = 12
                self.match(ExpresionesParser.PAI)
                self.state = 13
                self.expr(0)
                self.state = 14
                self.match(ExpresionesParser.PAD)
                pass
            elif token in [7]:
                self.state = 16
